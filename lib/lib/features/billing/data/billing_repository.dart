...
class BillingRepository {
  ...
  Future<Map<String, dynamic>> verifyApplePurchase({
    ...
    final callable = _functions.httpsCallable('verifyStorePurchase');
    ...
    final normalizedAccountToken = appAccountToken?.trim();
    if (normalizedAccountToken != null && normalizedAccountToken.isNotEmpty) {
      data['appAccountToken'] = normalizedAccountToken;
    }
