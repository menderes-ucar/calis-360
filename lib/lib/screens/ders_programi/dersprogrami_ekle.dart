...
class _DersprogramiEkleState extends ConsumerState<DersprogramiEkle> {
  ...
  String? secilenKonu;
  String? secilenGun;
  late int secilenHafta;

  @override
  void initState() {
    super.initState();
    secilenHafta = widget.initialWeekNumber < 1 ? 1 : widget.initialWeekNumber;
  }
      ...
      body: ListView(
        ...
        children: [
          SectionHeroCard(
            ...
            title: '$secilenHafta. haftaya çalışma ekle',
            subtitle:
                'Haftayı, sınav türünü, dersi, konuyu ve zamanı seç; çalışma seçtiğin haftaya kaydedilsin.',
          ),
                  ...
                  Row(
                    children: [
                      IconButton.filledTonal(
                        onPressed: _saving || secilenHafta <= 1
                            ? null
                            : () => setState(() => secilenHafta--),
